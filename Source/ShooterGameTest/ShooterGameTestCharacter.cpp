...
#include "ShooterGameTestCharacter.h"
...
void AShooterGameTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AShooterGameTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AShooterGameTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
bool AShooterGameTestCharacter::GetHasRifle()
{
	return bHasRifle;
}